                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('contact.send') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                <label for="exampleFormControlSelect1">Select SMTP</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="from" class="form-control" value="{{ old('from') }}"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">To emails</label>
                                <textarea rows="6" required name="to" class="form-control" value="{{ old('to') }}">{{ old('to') }}</textarea>
                            </div>
                            <div class="mb-3">
